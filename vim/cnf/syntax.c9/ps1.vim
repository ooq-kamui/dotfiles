...
hi ps1Cmdlet        ctermfg=cyan

hi ps1Keyword       ctermfg=lightyellow
hi ps1Repeat        ctermfg=lightyellow
hi ps1Operator      ctermfg=lightyellow
hi ps1Conditional   ctermfg=lightyellow
hi ps1Label         ctermfg=lightyellow

hi ps1Boolean       ctermfg=lightmagenta
