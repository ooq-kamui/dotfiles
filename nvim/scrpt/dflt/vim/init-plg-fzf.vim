...
func! Fzf_rg(...) abort " alias
  ...
  return v:lua.v.Fzf_rg(l:ptn, l:ext, l:word1)
...
func! Fzf_rg_with_grep(...) abort
  ...
  return v:lua.v.Fzf_rg_with_grep(l:ptn, l:ext, l:word1)
...
func! Fzf_rg_ext(ext) abort
  ...
  return v:lua.v.Fzf_rg_ext(a:ext)
...
func! Fzf_rg_word1(ptn) abort
  ...
  return v:lua.v.Fzf_rg_word1(a:ptn)
...
func! Fzf_rg_with_run(...) abort
  ...
  return v:lua.v.Fzf_rg_with_run(l:ptn)
...
func! Fzf_by_txt(...) abort
  ...
  return v:lua.v.Fzf_by_txt(l:src_txt, l:fnc_name)
...
func! Fzf_by_ar(...) abort
  ...
  return v:lua.v.Fzf_by_ar(l:src_ar, l:fnc_name)
...
func! Fzf_tag_jmp_by_file(...) abort
  ...
  return v:lua.v.Fzf_tag_jmp_by_file(l:file_path)
...
func! Fzf_doc_memo_opn() abort
  ...
  return v:lua.v.Fzf_doc_memo_opn()
...
func! Fzf_vim_fnc_call() abort
  ...
  return v:lua.v.Fzf_vim_fnc_call()
