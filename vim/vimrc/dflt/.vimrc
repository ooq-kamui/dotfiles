...
func! Opn_vimrc() abort
  ...
  if Is_env__('win32unix') " gitbash
    ...
    let l:vimrc_gitbash_file_path = '~/wrk/prj-pri/dotfiles/vim/.vimrc_gitbash'
...
if     Is_env__('mac')   " mac
  ...
  source ~/wrk/prj-pri/dotfiles/vim/vimrc/mac/.vimrc
...
elseif Is_env__('linux') " c9 s9
  ...
  source ~/wrk/prj-pri/dotfiles/vim/vimrc/c9/.vimrc
...
elseif Is_env__('win64') " pwsh ( for fzf )
  ...
  source ~/wrk/prj-pri/dotfiles/vim/vimrc/pwsh/.vimrc
...
elseif Is_env__('win32unix') " gitbash ( for fzf )
  ...
  source ~/wrk/prj-pri/dotfiles/vim/vimrc/gitbash/.vimrc
...
" when unknown server )
"   curl https://raw.githubusercontent.com/ooq-kamui/dotfiles/refs/heads/main/vim/.vimrc > .vimrc
"   vim -u .vimrc
