...
let g:init_lua_opt_file_path     = g:vimrc_dir . '/dflt/lua/init-opt.lua'
let g:init_lua_hl_file_path      = g:vimrc_dir . '/dflt/lua/init-hl.lua'
let g:init_lua_key_map_file_path = g:vimrc_dir . '/dflt/lua/init-key-map.lua'
let g:init_lua_fnc_file_path     = g:vimrc_dir . '/dflt/lua/init-fnc.lua'
...
" hl
" 
source `=g:vimrc_dir . '/dflt/init-vim-bk/init-hl.vim'`
...
" source `=g:vimrc_dir . '/dflt/init-vim-bk/init-key-map.vim'`
...
if g:env_dir != ''
  source `=g:vimrc_dir . '/' . g:env_dir . '/init.vim'`
else
  echo "is env else"
endif
